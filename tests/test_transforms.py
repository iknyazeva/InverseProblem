...
from inverse_problem.nn_inversion.transforms import normalize_output, Normalize
...
class TestTransforms:
    ...
    def test_normalize_one_spectrum(self, sample_from_database):
        sample = Normalize(norm_output=True)(sample_from_database)
        assert sample['X'][0].shape == (1,56,4)
