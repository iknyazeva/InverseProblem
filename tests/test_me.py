...
from inverse_problem.milne_edington.me import me_model,_compute_spectrum, _prepare_base_model_parameters, _prepare_zero_model_parameters
import numpy as np
from astropy.io import fits


# todo test parameters cheking from AboveParameters
...
class TestHinodeME:
    def test_compute_spectrum_zero(self):
        ...
        spectrum = obj.compute_spectrum(with_ff=False)
        expected_I = np.array([0.93969684,
                               0.93402373,
                               0.92755837,
                               0.92015735,
        ...
        spectrum_ff = obj.compute_spectrum(with_ff=True)
        assert isinstance(spectrum, np.ndarray)
    ...
    def test_compute_spectrum_ff(self):
        ...
        obj = HinodeME(param_vec)
        spectrum = obj.compute_spectrum_ff()
    ...
    def test_from_refer(self):
        ...
        spectrum = obj.compute_spectrum(with_ff=True)
        assert spectrum.shape == (56, 4)
